...
import com.example.yunpicturebackend.manager.auth.StpKit;
...
//            }
    ...
    public BaseResponse<Boolean> editPicture(@RequestBody PictureEditRequest pictureEditRequest, HttpServletRequest request) {
        ...
        // 将 PictureEditRequest 转换为 PictureUpdateRequest
        PictureUpdateRequest pictureUpdateRequest = new PictureUpdateRequest();
        BeanUtils.copyProperties(pictureEditRequest, pictureUpdateRequest);
