package com.example.yunpicturebackend.api.aliyun;
...
public class AliYunAiApi {
     ...
     * @throws Exception
     */
    public CreateOutPaintingTaskResponse createOutPaintingTask(CreateOutPaintingTaskRequest createOutPaintingTaskRequest) throws Exception {
        ...
        try (HttpResponse httpResponse = httpRequest.execute()) {
            if (!httpResponse.isOk()) {
                log.error("调用阿里云图像处理接口失败，响应内容: {}", httpResponse.body());
            ...
            if (createOutPaintingTaskResponse.getCode() != null) {
                log.error("调用阿里云图像处理接口失败，响应内容: {}", createOutPaintingTaskResponse.getMessage());
                throw new BusinessException(ErrorCode.OPERATION_ERROR, "接口调用失败" + createOutPaintingTaskResponse.getMessage());
            }
